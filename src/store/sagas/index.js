...
import { listGamerGames, addGamePoint, addGame } from './gamer';
...
export default function* rootSaga() {
  yield all([
    ...
    takeLatest(GamerTypes.ADD_GAME_POINT_REQUEST, addGamePoint),
    takeLatest(GamerTypes.ADD_GAMER_GAME_REQUEST, addGame),
